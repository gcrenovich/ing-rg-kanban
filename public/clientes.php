...
require_login();
$archivo = __DIR__ . '/../data/clientes.json';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($accion === 'agregar') {
        ...
        if ($nuevo['nombre'] === '') $mensaje = 'El nombre es obligatorio.';
        else {
            $clientes[] = $nuevo;
...
<table>
  <tr><th>ID</th><th>Nombre</th><th>Teléfono</th><th>Email</th><th>Dirección</th><th>Acciones</th></tr>
  ...
  <tr>
    ...
    <td>
      ...
      <button onclick="editarCliente(<?=htmlspecialchars(json_encode($c))?>)">✏️</button>
    </td>
  </tr>
  <?php endforeach; ?>
</table>
